  ...
  const onSubmitHandler = async (event) => {
    try {
      ...
      if (data && data.success) {
        ...
        // show inline error for expected failures (validation/auth)
        setFormError(data?.message || "Authentication failed");
      }
    } catch (error) {
      // Handle common status codes gracefully without toast for auth errors
      ...
      if (
        ...
        // for unexpected errors still show a toast
        toast.error(message);
      }
    }
  };
